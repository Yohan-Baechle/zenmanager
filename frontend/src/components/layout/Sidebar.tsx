...
export default function Sidebar() {
    ...
    return (
        <>
            {isMobileOrTablet && (
                <div
                    className={`fixed inset-0 top-[73px] bg-black/50 z-40 transition-opacity duration-200 ease-out ${showOverlay ? 'opacity-100' : 'opacity-0 pointer-events-none'}`}
            ...
            <aside className={`
                ...
                duration-300 
                overflow-hidden
                ${isMobileOrTablet && isOpen ? 'fixed left-0 top-[73px] z-50' : ''}
